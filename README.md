...
+ [Cамоучитель по Git (ru)](https://githowto.com/ru)
+ [Документация по Git (Eng)](https://git-scm.com/docs)
+ [Руководство по Git (v2)](https://git-scm.com/book/ru/v2)
+ [Шпаргалка по Git (ru)](https://www.evernote.com/shard/s368/client/snv?noteGuid=b1359883-2b9e-419a-b9de-dd959fc05f05&noteKey=97c0f19486d851b3&sn=https%3A%2F%2Fwww.evernote.com%2Fshard%2Fs368%2Fsh%2Fb1359883-2b9e-419a-b9de-dd959fc05f05%2F97c0f19486d851b3&title=Git)
...
+ [Octotree - расширение браузера, отображающее дерево кода в репозиториях GitHub](https://www.octotree.io)

## HTML
+ [Секреты использования семантической верстки в HTML5](https://medium.com/@stasonmars/секреты-использования-семантической-верстки-в-html5-c7cd5e6f1ebb)
+ [HTML5 Семантические элементы](https://html5css.ru/html/html5_semantic_elements.php)
+ [Семантические теги в HTML (GLO Academy)](https://www.youtube.com/watch?v=bQRmGxhARhc)
+ [Семантические теги HTML5](https://www.youtube.com/watch?v=_ih1xJyPk4A)

## JavaScript
+ [Современный учебник JavaScript](https://learn.javascript.ru)
+ [JavaScript Основы для Начинающих (Минин)](https://www.youtube.com/watch?v=Bluxbh9CaQ0)
+ [Исходники Минин](https://github.com/vladilenm/javascript-2020)
